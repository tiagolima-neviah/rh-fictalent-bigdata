...
) COMMENT='Catálogo de tipos de exame ocupacional';
...
) COMMENT='Cerca de 40 mil: ASO vencido com pessoa alocada é o alerta mais caro do painel';
...
) COMMENT='Obrigação legal por cliente e contrato, com validade';
...
) COMMENT='O adicional que entra na folha vem daqui';
...
) COMMENT='Cerca de 2 acidentes por 100 alocados por ano';
...
) COMMENT='A Comunicação de Acidente de Trabalho, obrigatória';
