...
| 6.2 (plano) | a auditoria de qualidade às cegas, notebook por domínio | PracStat cap. 1, *Exploratory Data Analysis* · acervo; Tukey cap. 2, *Schematic Summaries* e cap. 8, *Parallel and Wandering Schematic Plots* · acervo; PracStat cap. 3, *Multiple Testing* · acervo; Kahneman cap. 7, a máquina de tirar conclusões precipitadas · acervo; Karwin, partes II e III · fora do acervo | no Tukey, cercas e valores externos (cap. 2) e a comparação por lote (cap. 8, uma filial ao lado da outra); no PracStat, a trava contra achado falso; no Kahneman, o motivo de a auditoria ser às cegas (quem sabe o que foi plantado vê o que espera); no Karwin, os antipadrões que um banco legado carrega (*Fear of the Unknown*, os nulos; *Ambiguous Groups*) |
